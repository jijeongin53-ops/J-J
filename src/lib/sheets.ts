...
// 1. ONDO Wellness Experience 대표 상품 등록
export const ONDO_ECO_RESONANCE_PRODUCT: WellnessProduct = {
  id: 'ondo-eco-resonance-01',
  slug: 'ondo-eco-resonance',
  name: {
    ko: 'Program #1 ECO RESONANCE (에코 레조넌스)',
    en: 'Program #1 ECO RESONANCE: Healing Beyond Humans',
    ja: 'Program #1 ECO RESONANCE（エコー・レゾナンス）',
    zh: 'Program #1 ECO RESONANCE：生态共鸣身心疗愈',
  },
  category: {
    ko: '사하구 을숙도 웰니스 리추얼',
    ...
    if (typeof window !== 'undefined') {
      ...
      if (stored) {
        try {
          ...
          questions = [...ONDO_SURVEY_QUESTIONS, ...customQuestions];
        } catch {}
      }
    }
